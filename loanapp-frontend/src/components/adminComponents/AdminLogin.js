...
import useScript1 from "../../hooks/useScript1.js"

const AdminLogin = () => {
  

  useScript("https://getbootstrap.com/docs/5.3/assets/js/color-modes.js")
  useScript1("https://getbootstrap.com/docs/5.3/dist/js/bootstrap.bundle.min.js")
...
<link href="https://getbootstrap.com/docs/5.3/examples/sign-in/sign-in.css" rel="stylesheet"/>
  ...
  <div className="d-flex align-items-center py-4 bg-body-tertiary vsc-initialized">
    ...
    <div className="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle">
      <button className="btn btn-bd-primary py-2 dropdown-toggle d-flex align-items-center" id="bd-theme" type="button" aria-expanded="false" data-bs-toggle="dropdown" aria-label="Toggle theme (dark)" fdprocessedid="7da39j">
...
<main className="form-signin w-100 m-auto">
  <form onSubmit={submitActionHandler}>
    <img className="mb-4" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR5YiqtOgblyJioBRpohoT1jdR1rYeuQjrTZacozFw9HQ&s" alt="" width="72" height="57"/>
    <h1 className="h3 mb-3 fw-normal">Admin Please sign in</h1>

    <div className="form-floating">
    
      <input type="text" value={id} onChange={idChangeHandler} class="form-control" id="floatingInput" placeholder="name@example.com" fdprocessedid="q5g98"></input>

      <label for="floatingInput">Employee ID </label>
    </div>
    <div className="form-floating">
    
      <input type="password"  value={password} onChange={passwordChangeHandler} class="form-control" id="floatingPassword" placeholder="Password" fdprocessedid="ruwly"></input>
      <label for="floatingPassword">Password</label>
    </div>

   
    <button className="btn btn-primary w-100 py-2" type="submit" fdprocessedid="tjntuf">Login</button>
